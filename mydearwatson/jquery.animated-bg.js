...
$.fn.animatedbg = function(options) {
  ...
  var settings = $.extend({
      ...
      colors : ["#FFFACD", "#FFF5EE", " #FFFFF0", " #FFFFFF"],
      numParticles: 400
  }, options );
  ...
  /*t.css('background',"-moz-linear-gradient(45deg, rgba(125,203,212,0.5) 0%, rgba(150,205,211,0.3) 50%, rgba(228,245,252,0) 100%)")
   ...
   t.css('background',"-moz-linear-gradient(45deg, rgba(0,0,0,1.0) 0%, rgba(0,0,0,0.9) 50%, rgba(0,0,0,0.8) 100%)")
   .css('background',"-webkit-linear-gradient(45deg, rgba(0,0,0,1.0) 0%, rgba(0,0,0,0.9) 50%, rgba(0,0,0,0.8) 100%)")
   .css('background',"linear-gradient(45deg, rgba(0,0,0,1.0) 0%, rgba(0,0,0,0.9) 50%, rgba(0,0,0,0.8) 100%)")
  ...
  for(var i = 0; i < settings.numParticles; i++){
    ...
    $particle.css('position','absolute').css('border-radius','100%').css('opacity',0.8);
