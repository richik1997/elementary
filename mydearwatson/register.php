    ...
    <div class="row">
      <?php
          if(isset($_GET['msg']))
          {
            ...
            echo "alert('Registration unsuccessful. Please try again.');";
            echo "</script>";
             }
          }
          ?>
      ...
      <div class="col-md-4 col-sm-6 login-panel">
        ...
        <div class="panel panel-default">
          ...
          <div class="profile">
            ...
            <form class="form" action="register_user.php" method="POST">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" name="college" class="form-control" placeholder="Enter your College">
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
            ...
            <p class="text-white">Already a member? <a href="index.php">Login Here</a></p>
          </div>
        </div>
      </div>
